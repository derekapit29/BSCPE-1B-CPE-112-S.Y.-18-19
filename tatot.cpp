...
void cpe1b::palindromic_prime(long x)
	{
		//cout<<endl<<"PALINDROMIC PRIME?"<<endl;
...
void cpe1b::wasteful_number(long x)
	{
		//cout<<endl<<"WASTEFUL NUMBER?"<<endl;
		digit(x);
		if (digits>=factors)
			{
			//cout<<"WASTERFUL!"<<endl;
...
long cpe1b::reverse(long num2)
{
	...
	if (rev==num2)
	{
		//cout<<"PALINDROMIC PRIME KA!"<<endl;
	}
	else
	{
		cout<<num2<<endl;
